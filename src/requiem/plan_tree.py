...
def _walk(
    ...
    *,
    ...
    # Within _walk every node is decomposable (the header guarantees the root
    # is, and we only recurse into decomposable children), so children and
    # proposals must align 1:1.
