"""Event log — variant B copy (same format as variant A).

Same byte-for-byte format. Synchronous fsync; cooperates with
asyncio because writes are short and infrequent — they happen at
node boundaries, not in hot loops.
"""
